...
- Not a web framework
- Not async or high-performance
- Not production-ready
- Not feature-complete

This project exists to **build understanding**, not products.

---

## When to Stop

Stop adding features when you can:

- Explain the full request → response flow
- Explain how data is stored on disk
- Debug ownership and borrowing errors confidently
- Rebuild the system from scratch without guides

At that point, move on to:

- Async Rust
- Go backend services
- Real databases and web frameworks
